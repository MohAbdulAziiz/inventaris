...
</head><body class="min-h-screen flex bg-cover bg-center fade-in" style="background-image: url('public/smart.jpeg');">
        ...
        <form class="space-y-6" method="POST" action="">
          ...
          <div class="mb-4">
            <label class="flex items-center">
              <input type="checkbox" name="terms" required class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
              <span class="ml-2 text-sm text-gray-600">Apakah data LOGIN sudah sesuai?</span>
            </label>
          </div>
...
<!-- Right: Gambar smart.png -->
<div class="hidden md:flex md:w-2/5 lg:w-3/5 items-center justify-center perspective">
  <img src="../inventaris/public/smart.png" 
       alt="Smart" 
       class="max-w-[400px] max-h-[400px] w-full h-auto object-contain p-8 tilt-animation">
</div>

<style>
/* Supaya efek 3D kelihatan */
.perspective {
  perspective: 1000px;
}

/* Animasi miring ke belakang dan ke depan */
@keyframes tiltBackAndForth {
  0%, 100% {
    transform: rotateX(0deg);
  }
  25% {
    transform: rotateX(15deg); /* miring ke belakang */
  }
  50% {
    transform: rotateX(0deg); /* kembali lurus */
  }
  75% {
    transform: rotateX(-15deg); /* miring ke depan */
  }
}
